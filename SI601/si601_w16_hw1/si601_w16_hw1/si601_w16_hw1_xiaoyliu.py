...
Upop = []
HleT = []
#Get data from file and set them into lists
...
#Calculate sum for each country
...
#region_input.close()
#Problem occured with Region only has 117 entries
...
df_do2 = df_o
#Join the dataframes based on country
df_merged = pd.merge(df_do2,region_data,left_on='country name',right_on='country')
#Calculate urban population ratio for regions
...
#Sort the data according to average life expectancy
