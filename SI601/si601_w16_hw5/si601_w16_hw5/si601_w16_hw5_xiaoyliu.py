...
nei_sorted = nei.sortBy(lambda x: (x[0][0], -x[1]), ascending = True, numPartitions = 1)                
nei_sorted.map(lambda t : str(t[0][0]) + '\t' + str(t[0][1]) + '\t' + str(t[1]) + '\t' + str(t[2]) +'\t' + str(t[3])).saveAsTextFile('si601_w16_hw5_xiaoyliu')
